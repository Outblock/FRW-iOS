...
class TextFieldStyle {
    static let primary: VTextFieldModel = {
        ...
        model.colors.border = .init(
            enabled: Color.LL.rebackground.opacity(0.2),
        ...
        model.colors.clearButtonBackground = .init(
            enabled: .separator,
            focused: .separator,
            success: .separator,
            error: .separator,
...
//            .clear
        ...
        model.colors.footer = .init(
            enabled: Color.LL.note,
